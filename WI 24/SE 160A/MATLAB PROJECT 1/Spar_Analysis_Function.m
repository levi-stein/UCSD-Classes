...
for n = 1:nplot 
    ...
    Twist(n) = Twist(i) + (360/(2*pi))*(Mxo*(x(n)) - Mx1*(x(n)) - mx0*(x(n)^2)/2 - (mx1/Lo)*((x(n)^3)/6))/GJ - (360/(2*pi))*(Mxo*(x(i)) - Mx1*(x(i)) - mx0*(x(i)^2)/2 - (mx1/Lo)*((x(i)^3)/6))/GJ ;
    elseif (x(n)/Lo) > x1L && (x(n)/Lo) > x2L
    ...
    Twist(n) = Twist(j) + (360/(2*pi))*(Mxo*(x(n)) - Mx1*(x(n)) - Mx2*(x(n)) - mx0*(x(n)^2)/2 - (mx1/Lo)*((x(n)^3)/6))/GJ - (360/(2*pi))*(Mxo*(x(j)) - Mx1*(x(j)) - Mx2*(x(j)) - mx0*(x(j)^2)/2 - (mx1/Lo)*((x(j)^3)/6))/GJ;
    end
end
...
for n = 1:nplot
    ...
    Disp_Z(n) = -1*(Myo*((x(n)^2)/2) + Vzo*((x(n)^3/6)) - pz0*((x(n)^4)/24) - (pz2/(Lo^2))*((x(n)^6)/360) - (pz4/(Lo^4))*((x(n)^8)/1680) + (LF*rho*A*((x(n)^4)/24)))/EIzz;
    elseif (x(n)/Lo) > x1L && (x(n)/Lo) <= x2L
    Disp_X(n) = Disp_X(i) + (Fx2*x(n))/(EA) - (Fx2*x(i))/(EA);
    Disp_Y(n) = Disp_Y(i) + DvDxConti*x(n) - DvDxConti*x(i) + ((Mzo*((x(n)^2)/2) - Mz1*((x(n)^2)/2) + Fy1*((x(n)^3)/6) - Fy1*(x1L*Lo)*((x(n)^2)/2) - (Vyo/2)*((x(n)^3)/3) + (py0/6)*((x(n)^4)/4) + pyr*(x(n)^(rth+4))/((rth+1)*(rth+2)*(rth+3)*(rth+4)*(Lo^rth)))/EIyy) - ((Mzo*((x(i)^2)/2) - Mz1*((x(i)^2)/2) + Fy1*((x(i)^3)/6) - Fy1*(x1L*Lo)*((x(i)^2)/2) - (Vyo/2)*((x(i)^3)/3) + (py0/6)*((x(i)^4)/4) + pyr*(x(i)^(rth+4))/((rth+1)*(rth+2)*(rth+3)*(rth+4)*(Lo^rth)))/EIyy);
    Disp_Z(n) = Disp_Z(i) + DwDxConti*x(n) - DwDxConti*x(i) + (-1*(Myo*((x(n)^2)/2) - My1*((x(n)^2)/2) - Fz1*((x(n)^3)/6) + Fz1*(x1L*Lo)*((x(n)^2)/2) + Vzo*((x(n)^3)/6) - pz0*((x(n)^4)/24) - (pz2/(Lo^2))*((x(n)^6)/360) - (pz4/(Lo^4))*((x(n)^8)/1680) + (LF*rho*A*((x(n)^4)/24)))/EIzz) - (-1*(Myo*((x(i)^2)/2) - My1*((x(i)^2)/2) - Fz1*((x(i)^3)/6) + Fz1*(x1L*Lo)*((x(i)^2)/2) + Vzo*((x(i)^3/6)) - pz0*((x(i)^4)/24) - (pz2/(Lo^2))*((x(i)^6)/360) - (pz4/(Lo^4))*((x(i)^8)/1680) + (LF*rho*A*((x(i)^4)/24)))/EIzz);
    elseif (x(n)/Lo) > x1L && (x(n)/Lo) > x2L
    Disp_X(n) = Disp_X(n-1);
    Disp_Y(n) = Disp_Y(j) + DvDxContj*x(n) - DvDxContj*x(j) + ((Mzo*((x(n)^2)/2) - Mz1*((x(n)^2)/2)  - Mz2*((x(n)^2)/2) + Fy1*((x(n)^3)/6) - Fy1*(x1L*Lo)*((x(n)^2)/2) + Fy2*((x(n)^3)/6) - Fy2*(x2L*Lo)*((x(n)^2)/2) - (Vyo/2)*((x(n)^3)/3) + (py0/6)*((x(n)^4)/4) + pyr*(x(n)^(rth+4))/((rth+1)*(rth+2)*(rth+3)*(rth+4)*(Lo^rth)))/EIyy) - ((Mzo*((x(j)^2)/2) - Mz1*((x(j)^2)/2)  - Mz2*((x(j)^2)/2) + Fy1*((x(j)^3)/6) - Fy1*(x1L*Lo)*((x(j)^2)/2) + Fy2*((x(j)^3)/6) - Fy2*(x2L*Lo)*((x(j)^2)/2) - (Vyo/2)*((x(j)^3)/3) + (py0/6)*((x(j)^4)/4) + pyr*(x(j)^(rth+4))/((rth+1)*(rth+2)*(rth+3)*(rth+4)*(Lo^rth)))/EIyy);
    Disp_Z(n) = Disp_Z(j) + DwDxContj*x(n) - DwDxContj*x(j) + (-1*(Myo*((x(n)^2)/2) - My1*((x(n)^2)/2) - My2*((x(n)^2)/2) - Fz1*((x(n)^3)/6) + Fz1*(x1L*Lo)*((x(n)^2)/2) - Fz2*((x(n)^3)/6) + Fz2*(x2L*Lo)*((x(n)^2)/2) + Vzo*((x(n)^3)/6) - pz0*((x(n)^4)/24) - (pz2/(Lo^2))*((x(n)^6)/360) - (pz4/(Lo^4))*((x(n)^8)/1680) + (LF*rho*A*((x(n)^4)/24)))/EIzz) - (-1*(Myo*((x(j)^2)/2) - My1*((x(j)^2)/2) - My2*((x(j)^2)/2) - Fz1*((x(j)^3)/6) + Fz1*(x1L*Lo)*((x(j)^2)/2) - Fz2*((x(j)^3)/6) + Fz2*(x2L*Lo)*((x(j)^2)/2) + Vzo*((x(j)^3/6)) - pz0*((x(j)^4)/24) - (pz2/(Lo^2))*((x(j)^6)/360) - (pz4/(Lo^4))*((x(j)^8)/1680) + (LF*rho*A*((x(j)^4)/24)))/EIzz);
    end
end
