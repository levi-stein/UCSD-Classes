...
% GJ = Go_sk*((Iyy_str1 + (zc_str1^2)*A_str1) + (Iyy_str2 + (zc_str2^2)*A_str2) + (Iyy_str3 + (zc_str3^2)*A_str3) + (Iyy_str4 + (zc_str4^2)*A_str4) + (Izz_str1 + (yc_str1^2)*A_str1) + (Izz_str2 + (yc_str2^2)*A_str2) + (Izz_str3 + (yc_str3^2)*A_str3) + (Izz_str4 + (yc_str4^2)*A_str4));
% . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
...
Sxx_str1 = (10^3)*Eo_str1*[1 -(yc_str1) -(zc_str1)]*Snew*Pmat;
S_allow_T_str1 = min([(Syt_str1/SFy) (Sut_str1/SFu)]);
S_allow_C_str1 = min([(Syc_str1/SFy) (Suc_str1/SFu)]);
MS_str1T = (S_allow_T_str1/abs(Sxx_str1)) - 1;
MS_str1C = (abs(S_allow_C_str1)/abs(Sxx_str1)) - 1;
MS_str1 = min(MS_str1T, MS_str1C);

Sxx_str2 = (10^3)*Eo_str2*[1 -(yc_str2) (zc_str2)]*Snew*Pmat;
S_allow_T_str2 = min([(Syt_str2/SFy) (Sut_str2/SFu)]);
S_allow_C_str2 = min([(Syc_str2/SFy) (Suc_str2/SFu)]);
MS_str2T = (S_allow_T_str2/abs(Sxx_str2)) - 1;
MS_str2C = (abs(S_allow_C_str2)/abs(Sxx_str2)) - 1;
MS_str2 = min(MS_str2T, MS_str2C);

Sxx_str3 = (10^3)*Eo_str3*[1 -(yc_str3) -(zc_str3)]*Snew*Pmat;
S_allow_T_str3 = min([(Syt_str3/SFy) (Sut_str3/SFu)]);
S_allow_C_str3 = min([(Syc_str3/SFy) (Suc_str3/SFu)]);
MS_str3T = (S_allow_T_str3/abs(Sxx_str3)) - 1;
MS_str3C = (abs(S_allow_C_str3)/abs(Sxx_str3)) - 1;
MS_str3 = min(MS_str3T, MS_str3C);

Sxx_str4 = (10^3)*Eo_str4*[1 -(yc_str4) (zc_str4)]*Snew*Pmat;
S_allow_T_str4 = min([(Syt_str4/SFy) (Sut_str4/SFu)]);
S_allow_C_str4 = min([(Syc_str4/SFy) (Suc_str4/SFu)]);
MS_str4T = (S_allow_T_str4/abs(Sxx_str4)) - 1;
MS_str4C = (abs(S_allow_C_str4)/abs(Sxx_str4)) - 1;
